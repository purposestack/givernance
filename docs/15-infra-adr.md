...
- [ADR-007: Reject Convex.dev and Supabase as All-in-One Backend Replacements (Updated Context)](./adrs/adr-007-reject-convex-dev-and-supabase-as-all-in-one-backend-replacements-updated-context.md)
