...
| **Rôles autorisés** | Bannière : `org_admin` uniquement · Avatar sidebar : tous les rôles authentifiés (le remplacement par le logo n'est aujourd'hui effectif que pour les `org_admin`, cf. Description) |
