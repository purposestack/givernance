  ...
  <SelectPrimitive.Portal>
    <SelectPrimitive.Content
      ...
      className={cn(
        ...
        // Compositor properties only (E18); the popper offset below rides
        // the `translate` property so the scale motion never touches it.
        // The global reduced-motion block collapses both to instant (E17).
