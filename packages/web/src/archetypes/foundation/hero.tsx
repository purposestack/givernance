  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-outline-variant bg-surface-container-lowest shadow-card sm:rounded-3xl">
      <div
        ...
        style={{ backgroundColor: data.colorPrimary, color: "#ffffff" }}
      >
        ...
        {data.organisationLogoUrl ? (
          <div className="relative z-[1] mb-5 inline-flex h-12 w-12 overflow-hidden rounded-xl bg-white/10 backdrop-blur-sm sm:h-14 sm:w-14">
            <Image
        ...
        {data.organisationName ? (
          <p
            className="relative z-[1] text-[11px] font-medium uppercase tracking-[0.16em] sm:text-xs sm:tracking-[0.18em]"
        ...
        {data.title ? (
          <h1
            className="relative z-[1] mt-3 max-w-[24ch] text-balance font-heading text-2xl leading-tight sm:mt-4 sm:text-3xl lg:text-4xl"
            style={{ color: "#ffffff" }}
          >
            {data.title}
          </h1>
        ...
        {data.description ? (
          <p
            className="relative z-[1] mt-3 max-w-[52ch] text-sm leading-relaxed sm:mt-4 sm:text-base"
        ...
        {data.organisationMission ? (
          <p
            className="relative z-[1] mt-3 max-w-[52ch] font-heading text-xs italic leading-relaxed sm:text-sm"
