...
/**
 * Invitations table — pending / accepted / expired team invitations.
 *
 * Issue #161 split this out from the previous MembersTable: the page now
 * renders accepted **members** in their own table above this one, so this
 * component is dedicated to the invitation lifecycle (resend / revoke /
 * status badge). An "accepted" invitation row is informational only —
 * its underlying user is editable from the Members table.
 */
