...
function LoginForm() {
  ...
  return (
    <>
      ...
      {/* Locale picker — sits below the card, above the layout footer */}
      <select
        value={locale}
        onChange={handleLocaleChange}
        aria-label="Language"
        className="rounded-pill border border-neutral-200 bg-transparent px-3 py-1 text-xs font-medium text-text-muted transition-colors duration-normal ease-out hover:border-primary hover:text-text-secondary focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-primary"
      >
